---
name: add-skill
description: "Use when creating a new user-facing skill in the skills/ directory that teaches AI agents how to use a cx CLI command. Scaffolds the SKILL.md with proper frontmatter, trigger terms, reference file links, and syncs shared references."
metadata:
  internal: true
---
