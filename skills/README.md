...
| `coralogix-ai-center` | Instrument a GenAI app with OTel `gen_ai.*` spans, run it, and verify it renders in Coralogix AI Center — any language, provider, or framework |
